...
const IntroBlock = () => {
  return (
    <main id="intro" className="sm:w-3/4 p-10 m-20 text-center container mx-auto max-w-5xl">
        <Line />
        <h1 className="text-4xl sm:text-6xl uppercase font-bold tracking-wider py-2 my-10">Local Landscapers</h1>
